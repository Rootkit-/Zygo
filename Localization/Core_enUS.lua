...
If you're new to the guides, or have only started using them on this character, you can use the |cffddff00Smart Injection System|r to automatically find a proper starting spot for you. It might turn out to be far below your current level, if you skipped some useful quest chains or flight points, but the guide will catch up once you complete them.",
	...
	--['opt_group_mapinternal'] = "Internal waypointer",
		...
		['opt_arrow_display'] = "Arrow look and feel:",
			...
			['opt_arrowfreeze'] = "Lock arrow",			['opt_arrowfreeze_desc'] = "Make the pointer arrow transparent to mouse clicks.",
			...
			['opt_arrowunit'] = "Unit of measurement",		['opt_arrowunit_desc'] = "Select the unit system used in distance display.",
		...
		['opt_group_travelsystem'] = "Waypoint Arrow",			['opt_group_travelsystem_desc'] = "Adjust your settings for the travel system.",
		...
		['opt_autoacceptturnin'] = "Auto-accept and Turn-in guide quests",					['opt_autoacceptturnin_desc'] = "Automatically accept and turn in quests, if the guide instructs you to.\n|cffffaa88This makes questing very fast, but may be a bit confusing.",
		...
		['opt_analyzereps'] = "Show detailed reputation gains",			['opt_analyzereps_desc'] = "Display verbose reputation gain messages in chat, showing percentage gained and next standing.",
		['opt_autotaxi'] = "Automatically take suggested flight paths",			['opt_autotaxi_desc'] = "Automatically take taxi flights, when talking to a flightmaster, if the travel system suggests it.",
	...
	['opt_group_petbattle'] = "Pet Battle",		['opt_group_petbattle_desc'] = "Features enhancing your Pet Battles experience.",
		['opt_petbattleframe'] = "Enable Pet Battle Info Panel",			['opt_petbattleframe_desc'] = "Shows the information frame that is visible when you enter a pet battle.",
	...
	['opt_group_gold'] = "Gold",							['opt_group_gold_desc'] = "",
	...
	['opt_group_share'] = "Sync & Share",
		...
		['opt_sync_enabled_desc'] = "Enable communication between Zygor Guides users in your party, allowing for synchronizing progress or sharing your guides with your party.",
		['opt_sync_snap'] = "Sync party progress",
		['opt_sync_snap_desc'] = "When using the same guide, wait on each step until everyone completes it.",
	...
	['opt_group_itemscore_warning'] = "Here you can adjust the stat weights used by the Gear Advisor to suggest item upgrades.|nThis is an advanced feature so only adjust these values if you know what you're doing.",
	...
	opt_group_notification = "Notifications",								opt_group_notification_desc = "Manage Creature Detector, pop-ups, and other features that can be completed as you need.",
		opt_n_nc = "Notification Center",
			...
			opt_n_nc_no_popups = "Send all popups to Notification Center",		opt_n_nc_no_popups_desc = "If a pop-up can be sent to the Notification Center then it will automatically appear there and not pop-up.",
		...
		opt_n_popup_enable = "Enable notification popups",
			opt_n_popup_hideall = "Hide popups if Viewer is closed",			opt_n_popup_hideall_desc = "This will suppress all pop-ups when the Zygor Guide Viewer is closed.\nIf disabled, only pop-ups not guide related will show up.",
			opt_notify_following = "Notify me when:",
				opt_n_popup_guides = "Show next guide popup",						opt_n_popup_guides_desc = "Show a pop-up suggesting possible further Leveling Guides in nearby zones, when you complete your current Leveling Guide.",
				...
				opt_n_popup_dungeon = "Show dungeon guide popup",					opt_n_popup_dungeon_desc = "Display a pop-up window suggesting the guide for a dungeon when you enter the dungeon.",
				opt_n_popup_monk = "Show monk daily popup",								opt_n_popup_monk_desc = "Display a pop-up window for Monk class quests every 10 levels and for the daily.",
				opt_n_popup_pet = "Show creature detector popup",							opt_n_popup_pet_desc = "Display a pop-up window with a guide on how to obtain a targeted pet or the targeted player's mount.",
				opt_n_popup_wq = "Show world quest popup",							opt_n_popup_wq_desc = "Display a pop-up window with a guide on how to complete selected world quest.",
...
--]]
	...
	['static_loadmountguide'] = "You've reached the level required to obtain a %s riding skill. Would you like to load the guide for obtaining it? Guide will be loaded in a new tab.",
	...
	share_invite_abort = "Do you want to stop sharing your guide?",
