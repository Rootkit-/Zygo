...
---------------------
	...
	--## ALLIANCE ##--
		...
		"Oribos/0 20.86,45.67 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind} "..
			"{cond:PlayerCompletedQuest(60151)}",

		-- Stormwind City	-to-		Oribos
		"Stormwind City/0 47.56,94.96 -to- Oribos/0 20.34,50.31 {fac:A} {mode:PORTAL} {title:Click the Portal to Oribos\nInside the Portal Room} "..
			"{cond:PlayerCompletedQuest(60151)}",
	...
	--## Neutral ##--
		...
		"Oribos/0 52.08,57.92 -to- Oribos/1 49.52,60.92 {mode:PORTAL} {cost:1} {title:Click To Ring of Transference\nto Teleport Upstairs} "..
			"{cond:PlayerCompletedQuest(60154)}",

		-- Oribos Transport Portal (Downstairs to Upstairs) #2
		"Oribos/0 52.10,42.74 -to- Oribos/1 49.38,42.00 {mode:PORTAL} {cost:1} {title:Click To Ring of Transference\nto Teleport Upstairs} "..
			"{cond:PlayerCompletedQuest(60154)}",

		-- Oribos Transport Portal (Downstairs to Upstairs) #3
		"Oribos/0 57.14,50.36 -to- Oribos/1 55.66,51.62 {mode:PORTAL} {cost:1} {title:Click To Ring of Transference\nto Teleport Upstairs} "..
			"{cond:PlayerCompletedQuest(60154)}",

		-- Oribos Transport Portal (Downstairs to Upstairs) #3
		"Oribos/0 47.02,50.34 -to- Oribos/1 43.38,51.56 {mode:PORTAL} {cost:1} {title:Click To Ring of Transference\nto Teleport Upstairs} "..
			"{cond:PlayerCompletedQuest(60154)}",

		-- Oribos Transport Portal (Upstairs to Downstairs) #1
		"Oribos/1 49.55,60.85 -to- Oribos/0 52.07,57.86 {mode:PORTAL} {cost:1} {title:Click To Ring of Fates\nto Teleport Downstairs} "..
			"{cond:PlayerCompletedQuest(60154)}",

		-- Oribos Transport Portal (Upstairs to Downstairs) #2
		"Oribos/1 49.56,42.35 -to- Oribos/0 52.10,42.44 {mode:PORTAL} {cost:1} {title:Click To Ring of Fates\nto Teleport Downstairs} "..
			"{cond:PlayerCompletedQuest(60154)}",

		-- Oribos Transport Portal (Upstairs to Downstairs) #3
		"Oribos/1 55.68,51.59 -to- Oribos/0 57.14,50.36 {mode:PORTAL} {cost:1} {title:Click To Ring of Fates\nto Teleport Downstairs} "..
			"{cond:PlayerCompletedQuest(60154)}",

		-- Oribos Transport Portal (Upstairs to Downstairs) #4
		"Oribos/1 43.44,51.57 -to- Oribos/0 47.12,50.30 {mode:PORTAL} {cost:1} {title:Click To Ring of Fates\nto Teleport Downstairs} "..
			"{cond:PlayerCompletedQuest(60154)}",
	...
	--## Neutral ##--
		...
		"Bastion/0 53.30,44.90 <region:heros_rest> -to- Bastion/0 52.99,37.84 {cost:1} {mode:PORTAL} {title:Click the Anima Gateway\nto Leave Hero's Rest} "..
			"{cond:PlayerCompletedQuest(59196) or PlayerIsOnQuest(59196)}",
	...
	--## Neutral ##--
		...
		"The Maw/0 48.29,41.45 -to- The Maw/0 34.19,14.73 {mode:PORTAL} {title:Talk to the Animaflow Teleporter\nChoose |cfff0e081\"The Tremaculum\"|r} "..
			"{cond:PlayerCompletedQuest(63177)}",
		...
		"The Maw/0 48.29,41.45 -to- The Maw/0 53.42,63.64 {mode:PORTAL} {title:Talk to the Animaflow Teleporter\nChoose |cfff0e081\"The Beastwarrens\"|r} "..
			"{cond:PlayerCompletedQuest(63177) and PlayerCompletedQuest(60285)}",
	...
	--## HORDE ##--
		...
		"Orgrimmar/1 49.23,36.52 -to- Abyssal Depths/0 51.40,61.01 {fac:H} {mode:PORTAL} {cond:PlayerCompletedQuest(26784) or PlayerLevel() >= 50}",
		...
		"Orgrimmar/1 57.47,92.27 -to- The Jade Forest/0 28.56,13.98 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10} "..
	...
	--## ALLIANCE ##--
		...
		"Stormwind City/0 73.30,16.87 -to- Abyssal Depths 55.7,72.8 {fac:A} {mode:PORTAL} {cond:PlayerCompletedQuest(14482) or PlayerLevel() >= 50}",--Check dest
		...
		"Stormwind City/0 44.36,88.71 -to- Dalaran/1 55.92,46.79 {fac:A} {mode:PORTAL} "..
		...
		"Stormwind City/0 46.85,93.41 -to- Azsuna/0 47.00,40.89 {fac:A} {mode:PORTAL} {cond:ZGV.IsLegionOn()} "..
		...
		"Stormwind City/0 43.72,85.35 -to- Tanaris/17 54.60,28.30 {fac:A} {mode:PORTAL} {title:Click the Portal to Caverns of Time Inside the Mage Tower}",

		-- Stormwind City - Elwynn Forest, Eastern Kingdoms -to- The Exodar - Azuremyst Isle, Kalimdor --CHECKED
		"Stormwind City/0 43.60,87.22 -to- The Exodar/0 47.62,59.82 {fac:A} {mode:PORTAL} {title:Click the Portal to The Exodar Inside the Mage Tower}",

		-- Stormwind City - Elwynn Forest, Eastern Kingdoms -to- Paw'don Village - The Jade Forest, Pandaria --CHECKED
		"Stormwind City/0 45.70,87.16 -to- The Jade Forest/0 46.18,85.07 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10} "..
		...
		"Stormwind City/0 48.75,95.21 -to- Boralus/0 70.62,16.98 {fac:A} {mode:PORTAL} {cond:PlayerCompletedQuest(47186)} "..
		...
		"Stormwind City/0 44.91,85.72 -to- Shattrath City/0 54.97,40.23 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10}"..
		...
		"Stormwind City/0 44.91,85.72 <override_text:You must be at least 10 to enter Outland.> <override_icon:error> -to- Shattrath City/0 54.97,40.23 "..
	...
	--## ALLIANCE ##--
		...
		"Hellfire Peninsula/0 89.22,51.00 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10}",

		-- The Stair of Destiny - Hellfire Peninsula, Outland -to- Stormwind - Elwynn Forest, Eastern Kingdoms --CHECKED
		"Hellfire Peninsula/0 88.62,52.81 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10}",

		-- Shattrath City - Terokka Forest, Outland -to- Stormwind - Elwynn Forest, Eastern Kingdoms --CHECKED
		"Shattrath City/0 57.21,48.27 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {cost:15} {cond:PlayerLevel() >= 10}",
	...
	--## HORDE ##--
		...
		"Durotar 66,1 <title:Hellscream's Fist Airship> -to- The Jade Forest 28.5,14.0 {fac:H} {mode:PORTAL} "..
			"{cond:PlayerLevel()>=10 and not PlayerCompletedQuest(31769) and not ZGV.IsLegionOn()}",
	...
	-- HIGHMOUNTAIN TAUREN
		"Thunder Totem/6 46.02,63.74 -to- Orgrimmar/1 39.84,77.25 {mode:PORTAL} {title_atob:Click the Portal to Orgrimmar} {cond:ZGV:RaceClassMatch('HIGHMOUNTAINTAUREN') and PlayerLevel() >= 45}",

		"Orgrimmar/1 40.09,76.83 -to- Thunder Totem/6 44.17,64.06 {mode:PORTAL} {title_atob:Click the Portal to Thunder Totem} {cond:ZGV:RaceClassMatch('HIGHMOUNTAINTAUREN') and PlayerLevel() >= 45}",
	...
	-- NIGHTBORNE
		...
		"Orgrimmar/1 40.09,76.84 -to- Suramar/0 59.55,85.29 {mode:PORTAL} {title_atob:Click the Portal to The Nighthold} {cond:ZGV:RaceClassMatch('NIGHTBORNE') and PlayerLevel() >= 45}",
