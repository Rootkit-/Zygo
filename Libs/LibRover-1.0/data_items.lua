...
data.portkeys = { -- smile if you're a muggle
	...
	{item=182773, destination="_HEARTH", cost=hearthcost, toy=true,function() local c=ZGV.Parser.ConditionEnv return c.covenant()==c.Necrolord end}, -- Necrolord Hearthstone
	{item=184353, destination="_HEARTH", cost=hearthcost, toy=true,function() local c=ZGV.Parser.ConditionEnv return c.covenant()==c.Kyrian end}, -- Kyrian Hearthstone
	{item=183716, destination="_HEARTH", cost=hearthcost, toy=true,function() local c=ZGV.Parser.ConditionEnv return c.covenant()==c.Venthyr end}, -- Venthyr Hearthstone
	{item=180290, destination="_HEARTH", cost=hearthcost, toy=true,function() local c=ZGV.Parser.ConditionEnv return c.covenant()==c.NightFae end}, -- Night Fae Hearthstone
