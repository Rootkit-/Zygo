...
local SHADOWLANDS_ZONEGROUPS = {
	[1670]=1,[1671]=1,[1672]=1,[1673]=1, -- Oribos floors
	[1536]=2, -- Maldraxxus
	[1533]=3, -- Bastion
	[1536]=4, -- Ardenweald
	[1525]=5, -- Revendreth
...
function Node:CanFlyTo(dest,debug)
	...
	if (c==MAPENUM_SHADOWLANDS and dest_c==MAPENUM_SHADOWLANDS) and SHADOWLANDS_ZONEGROUPS[m]~=SHADOWLANDS_ZONEGROUPS[dest_m] then return false,debug and "no flying between SL zones" end
