...
accept Return Lost Souls##62861 |goto Elysian Hold/1 59.52,34.26 |only if covenant() == Kyrian and covenantrenown() >= 15 and covenantrenown() < 24 and not completedq(61332)
accept Return Lost Souls##62862 |goto Elysian Hold/1 59.52,34.26 |only if covenant() == Kyrian and covenantrenown() >= 24 and covenantrenown() < 32 and not completedq(62861)
accept Return Lost Souls##62863 |goto Elysian Hold/1 59.52,34.26 |only if covenant() == Kyrian and covenantrenown() >= 32 and not completedq(62862)
...
accept Return Lost Souls##62864 |goto Seat of the Primus/0 46.66,42.38 |only if covenant() == Necrolord and covenantrenown() >= 15 and covenantrenown() < 24 and not completedq(61333)
accept Return Lost Souls##62865 |goto Seat of the Primus/0 46.66,42.38 |only if covenant() == Necrolord and covenantrenown() >= 24 and covenantrenown() < 32 and not completedq(62864)
accept Return Lost Souls##62866 |goto Seat of the Primus/0 46.66,42.38 |only if covenant() == Necrolord and covenantrenown() >= 32 and not completedq(62865)
...
accept Return Lost Souls##61331 |goto Heart of the Forest/0 33.91,43.49		|only if questactive(61331) or completedq(61331)	|only if covenant() == NightFae and covenantrenown() < 15
accept Return Lost Souls##62858 |goto Heart of the Forest/0 33.91,43.49		|only if questactive(62858) or completedq(62858)	|only if covenant() == NightFae and covenantrenown() >= 15 and covenantrenown() < 24 and not completedq(61331)
accept Return Lost Souls##62859 |goto Heart of the Forest/0 33.91,43.49		|only if questactive(62859) or completedq(62859)	|only if covenant() == NightFae and covenantrenown() >= 24 and covenantrenown() < 32 and not completedq(62858)
accept Return Lost Souls##62860 |goto Heart of the Forest/0 33.91,43.49		|only if questactive(62860) or completedq(62860)	|only if covenant() == NightFae and covenantrenown() >= 32 and not completedq(62859)
...
Accept the Daily Quest |condition false |goto 50.75,53.29 |or
step
talk Marasmius##167455
...
accept Return Lost Souls##62867 |goto 45.41,28.47 |only if covenant() == Venthyr and covenantrenown() >= 15 and covenantrenown() < 24 and not completedq(61334)
