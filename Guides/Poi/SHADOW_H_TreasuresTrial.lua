...
'|condition itemcount(180753) == 1 or completedq(61074) |or
step
...
steps=[[
step
kill Young Etherwyrm##163546+
collect 1 Broken Kyrian Flute##180536 |goto Bastion/0 42.93,45.61 |q 61053 |future
step
...
Gain the "Taskmaster's Trove" Buff |condition hasbuff("spell:341237") or completedq(62199) |goto Revendreth/0 63.01,72.36
step
...
steps=[[
step
Collect 99 Infused Rubies |condition curcount(1820) >= 99 or completedq(62063)
|tip Collect them by killing rare mobs, completing covenant callings, looting treasures, and running dungeons.
step
...
'|condition itemcount(180229) == 0 and itemcount(180219) == 0 and itemcount(180222) == 0 and itemcount(180221) == 0 and itemcount(180227) == 0 and itemcount(180225) == 0 and not completedq(60202) |or |next "Collect_Book"
]],
},
{
treasure=[[Secret Treasure]],
