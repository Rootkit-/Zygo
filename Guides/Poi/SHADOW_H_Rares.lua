...
kill Deifir the Untamed##164238 |confirm |q 62271 |goto Ardenweald/0 47.52,28.45 |future
]],
},
{
rare=[[Dustbrawl]],
...
step
Kill enemies around this area
collect Unusually Large Mushroom##175247 |goto Ardenweald/0 30.83,37.86 |condition hasmount(339632)
...
Enter Soulshape |havebuff spell:310143 |goto Ardenweald/0 39.48,61.36 |q 59220 |future
step
...
steps=[[
step
Let the Enemies Kill You |goto Bastion/0 27.40,27.38 |condition isdead() |q 60883 |future
...
collect 10 Weak Anima Mote##172451 |confirm |q 57708 |goto Bastion/0 42.88,80.51 |future
step
...
click Aspirant's Chest##336428 |confirm |q 57708 |goto 42.94,83.02 |future
]],
},
{
...
steps=[[
step
kill Wingflayer the Cruel##167078 |confirm |q 62197 |goto Bastion/0 40.63,53.06 |future
]],
},
{
...
_Need quest ID:_
kill Manifestation of Wrath##170048 |confirm |q 60729 |goto 50.84,31.99 |future
Return the souls to [49.02,34.86]
]],
},
{
...
collect 1 Dominion Etching: Pain##182326 |goto The Maw/0 28.70,12.04 |condition itemcount(182326) == 1 or itemcount(182329) == 1 or completedq(62260)
...
|tip Use the POI feature to accomplish this.
collect 1 Dominion Etching: Loss##182327 |goto 19.32,41.72 |condition itemcount(182327) == 1 or itemcount(182329) == 1 or completedq(62260)
|tip This item is required to create a Domination's Calling, which is used to summon Exos, Herald of Domination.
step
kill Ekphoras, Herald of Grief##169827
|tip Use the POI feature to accomplish this.
collect 1 Dominion Etching: Grief##182328 |goto 42.34,21.08 |condition itemcount(182328) == 1 or itemcount(182329) == 1 or completedq(62260)
|tip This item is required to create a Domination's Calling, which is used to summon Exos, Herald of Domination.
step
