...
ZygorGuidesViewer:RegisterGuide("GOLD\\Gathering\\Callous Hide (Ardenweald)",{
	...
	label "Start"
		...
		|tip Follow the path, killing and skinning along the way.
		|goldcollect 80 Callous Hide##172094 |n
		|goldtracker
		|tip
		_Ready to Sell?_
		Click Here to Sell Your Items on the Auction House |confirm
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Gathering\\Heavy Callous Hide (Ardenweald)",{--
	meta={goldtype="route",skillreq={shadowlands_skinning=1},levelreq={50}},
	items={{172097,12}},
	maps={"Ardenweald"},
	},[[
	...
	label "Start"
		...
		kill Gorm Ravener##158364+
		|tip Follow the path, killing and skinning along the way.
		|goldcollect 12 Heavy Callous Hide##172097 |n
		|goldtracker
		|tip
		_Ready to Sell?_
		Click Here to Sell Your Items on the Auction House |confirm
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Gathering\\Heavy Desolate Leather (Ardenweald)",{
	meta={goldtype="route",skillreq={shadowlands_skinning=1},levelreq={50}},
	items={{172096,16}},
	maps={"Ardenweald"},
	},[[
	...
	label "Start"
		...
		kill Gorm Ravener##158364+
		|tip Follow the path, killing and skinning along the way.
		|goldcollect 16 Heavy Desolate Leather##172096 |n
		|goldtracker
		|tip
		_Ready to Sell?_
		Click Here to Sell Your Items on the Auction House |confirm
