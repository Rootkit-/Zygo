...
-----    SKINNING    -----
--------------------------
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Stonehide Leather",{
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Stormscale",{
	meta={goldtype="route",skillreq={legion_skinning=1},levelreq=10},
	items={{124115,420}},
	maps={"Highmountain"},
	},[[
...
-----    HERBALISM    -----
---------------------------
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Aethril",{
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Dreamleaf",{
	meta={goldtype="route",skillreq={legion_herbalism=1},levelreq=10},
	items={{124102,420}},
	maps={"Val'sharah"},
	},[[
...
-----    MINING    -----
------------------------
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Leystone Ore & Felslate (Mining Route)",{
