...
|only if not havequest(62723) and not completedq(62723)
step
talk Tal-Inara##159478
...
accept The Next Step##63208 |goto Oribos/0 38.89,69.99 |only if not havequest(62748) and not completedq(62748)
step
talk Tal-Inara##159478
Tell her _"Show me how I can help the Shadowlands."_
...
accept Furthering the Purpose##63209 |goto Oribos/0 38.89,69.99 |only if not havequest(62763) and not completedq(62763)
step
talk Tal-Inara##159478
Tell her _"Show me how I can help the Shadowlands."_
...
accept The Last Step##63210 |goto Oribos/0 38.89,69.99 |only if not havequest(62778) and not completedq(62778)
step
talk Tal-Inara##159478
Tell her _"Show me how I can help the Shadowlands."_
...
step
Click Here After Reaching Apprehensive Reputation with Ve'nari |confirm |q 63051 |future
step
talk Ve'rayn##168432
...
step
Click Here After Reaching Tentative Reputation with Ve'nari |confirm |q 60284 |future
step
talk Ve'nari##162804
...
step
Click Here After Reaching Ambivalent Reputation with Ve'nari |confirm |q 60285 |future
step
talk Ve'nari##162804
...
|only if not havequest(63211) or completedq(63211)
step
talk Polemarch Adrestes##171787
turnin Report to Adrestes##63211 |goto 36.16,64.17 |only if not havequest(63211) or completedq(63211)
...
step
talk Polemarch Adrestes##160037
accept Assistance from Sinfall##58557 |goto Elysian Hold/0 55.68,41.93
step
...
talk Polemarch Adrestes##160037
|tip Upstairs.
accept Meet the Queen##58775 |goto 55.65,41.96
step
...
|only if not havequest(63214) or completedq(63214)
step
talk Lady Moonberry##171795
turnin Report to Moonberry##63214 |goto Oribos/0 39.77,60.88 |only if not havequest(63214) or completedq(63214)
...
|only if not havequest(58609) or completedq(58609)
step
talk Secutor Mevix##171821
turnin Report to Mevix##63212 |goto 42.97,74.21 |only if not havequest(58609) or completedq(58609)
