...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Zandalar\\Zuldazar (10-50)",{
...
accept Mission Statement##51443 |goto Orgrimmar/1 49.39,76.57
|only if not havequest(60361) and not completedq(60361)
step
Speak to Warchief Sylvanas Windrunner in Orgrimmar |q 51443/1 |goto 49.69,75.07
|only if havequest(51443)
step
...
|tip Inside the building.
turnin Mission Statement##51443 |goto 54.44,78.43
|only if havequest(51443) or completedq(51443)
step
talk Nathanos Blightcaller##135205
|tip Inside the building.
...
|tip Inside the building.
accept Zuldazar##47514 |goto 41.65,69.21
step
talk Princess Talanji##133050
|tip Inside the building.
...
Enter the building |goto 42.80,83.58 < 7 |walk
...
step
Run up the stairs |goto 57.50,90.72 < 10 |only if walking
Enter the building |goto 57.20,87.96 < 7 |walk
...
step
Follow the path |goto 50.59,77.92 < 20 |only if walking
click Ancient Gong
...
step
Follow the path |goto 46.84,77.05 < 30 |only if walking
...
step
Run up the stairs |goto 51.75,19.06 < 10 |only if walking
...
accept Rituals of Heresy##47527 |goto 50.70,29.65 |only if level < 10
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Zandalar\\Nazmir (10-50)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Zandalar\\Vol'dun (10-50)",{
author="support@zygorguides.com",
...
accept Monsters of Zem'lan##47647 |goto 35.31,83.20 |only if level < 10
...
|only if not havequest(52746) and not completedq(52746)
step
talk Nathanos Blightcaller##135691
turnin The War Campaign##52749 |goto Zuldazar/0 58.44,62.67 |only if havequest(52749) or completedq(52749)
...
|tip Use the Leveling guides to accomplish this.
step
accept A Dying World##53028 |goto Dazar'alor/0 51,88
|tip You will accept this quest automatically.
...
step
talk Nathanos Blightcaller##135691
turnin Uniting Zandalar##51916 |goto 58.44,62.67 |only if havequest(51916) or completedq(51916)
turnin Uniting Zandalar##52451 |goto 58.44,62.67 |only if havequest(52451) or completedq(52451)
step
talk Nathanos Blightcaller##135691
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Swiftwind Post (Drustvar)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Wolf's Den (Tiragarde Sound)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Hillcrest Pasture (Stormsong Valley)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Mudfisher Cove (Drustvar)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Stonefist Watch (Tiragarde Sound)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Stonetusk Watch (Stormsong Valley)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Windfall Cavern (Stormsong Valley)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Nightborne Race Unlock",{
author="support@zygorguides.com",
description="\nThis guide will walk you through unlocking the new Nightborne allied race.",
condition_suggested=function() return level >= 50 and not completedq(49614) end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Highmountain Tauren Race Unlock",{
author="support@zygorguides.com",
description="\nThis guide will walk you through unlocking the new Highmountain Tauren allied race.",
condition_suggested=function() return level >= 50 and not completedq(48433) end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Mag'har Orc Race Unlock",{
author="support@zygorguides.com",
...
condition_suggested=function() return level >= 50 and not achieved(12518) and completedq(52131) end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Vulpera Race Unlock",{
author="support@zygorguides.com",
...
condition_suggested=function() return level >= 50 and not achieved(13206) and achieved(12478) and rep('Voldunai') == Exalted end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Zandalari Troll Race Unlock",{
author="support@zygorguides.com",
...
condition_suggested=function() return level >= 50 and not achieved(13161) and achieved(13466) and achieved(12479) and rep('Zandalari Empire') == Exalted end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Zandalar\\Zuldazar Loremaster (Story Quest Only)",{
author="support@zygorguides.com",
description="\nThis guide will assist you in completing the following Zuldazar storylines:\n\nAudience with the King\nPort of Zandalar\nWeb of Lies\nThe Zanchuli Council\nPortents and Prophecies\nWarport Rastari\nAmong the People\nMarch of the Loa",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Zandalar\\Nazmir Loremaster (Story Quest Only)",{
author="support@zygorguides.com",
description="\nThis guide will assist you in completing the following Nazmir storylines:\n\nDeep in the Swamp\nUndercover Sista\nA Friend of the Frogs\nBring the Boom\nA Pact with Death\nTurtle Power\nEverything Contained\nBleeding the Blood Trolls",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Zandalar\\Vol'dun Loremaster (Story Quest Only)",{
author="support@zygorguides.com",
description="\nThis guide will assist you in completing the following Voldun storylines:\n\nDangers in the Desert\nA City of Secrets\nStorming the Spire\nUnlikely Allies\nThe Warguard's Fate\nThe Three Keepers\nAtul'Aman",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Mysterious Letter Questline",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Heritage Armor\\Blood Elf Heritage Armor",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Heritage Armor\\Goblin Heritage Armor",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Heritage Armor\\Tauren Heritage Armor",{
author="support@zygorguides.com",
...
step
Reach the Murloc Hideaway |goto Exile's Reach/0 62.14,84.10 < 30 |noway |c |q 59929 |future
step
talk Warlord Breka Grimaxe##166782
accept Murloc Mania##59929 |goto 61.88,82.89
step
...
step
click Campfire
collect Cooked Meat##174074 |q 59932/2 |goto 58.32,74.58
step
talk Won'sa##166854
...
step
Watch the dialogue
Use the Choppy Booster Mk 5 to Scout the Area |q 59940/1 |goto 55.04,54.20
step
Watch the dialogue
Return to Cork Fizzlepop |goto 56.07,58.80 < 10 |c |q 59940 |notravel
step
talk Cork Fizzlepop##167019
...
Watch the dialogue
|tip Use your "Tame Beast" ability on the Wolf that appears nearby.
...
step
Reach Orgrimmar |goto Orgrimmar/1 52.56,88.71 < 10 |c |q 59985 |notravel
step
talk Warlord Breka Grimaxe##168431
turnin An End to Beginnings##59985 |goto 52.51,88.11
accept Welcome to Orgrimmar##60343 |goto 52.51,88.11
step
...
step
Enter the building |goto 70.34,48.98 < 7 |walk
...
accept Mission Statement##60361 |goto 48.26,71.39
step
Watch the dialogue
|tip Inside the building.
...
step
Travel to Zuldazar |goto Zuldazar/0 57.98,62.80 < 10 |noway |c |q 60361
step
talk Nathanos Blightcaller##121210
turnin Mission Statement##60361 |goto Zuldazar/0 57.96,62.76
step
talk Princess Talanji##132332
accept Welcome to Zuldazar##46957 |goto 57.95,62.46
step
...
No - Level in Battle for Azeroth Zones	|confirm	|or	|next Leveling Guides\\Battle for Azeroth (10-50)\\Zandalar\\Zuldazar (10-50)
...
Talk to the Thrallmar Mage |q 60123/1 |goto Orgrimmar/1 56.93,88.33
|only if havequest(60123)
step
...
step
Click the Complete Quest Box:
turnin To Outland!##60123 |only if havequest(60123) or completedq(60123)
...
accept To Northrend!##60097			|or |only if havequest(60097)
accept Onward to Adventure: Northrend##60963	|or |only if havequest(60963)
|tip You will accept one of these quests automatically.
step
...
|only if havequest(60963)
step
Click the Complete Quest Box:
turnin To Northrend!##60097 |only if havequest(60097) or completedq(60097)
turnin Onward to Adventure: Northrend##60963 |only if havequest(60963) or completedq(60963)
step
...
|next Leveling Guides\\Pandaria (10-50)\\The Jade Forest (10-50)
step
...
Talk to the Vanguard Battlemage |q 34398/1 |goto Orgrimmar/1 57.69,88.36
|only if havequest(34398)
step
