...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Tiragarde Sound (10-50)",{
...
condition_suggested=function() return level >= 10 and level < 50 and not completedq(50972) end,
startlevel=10,
endlevel=50,
...
|only if not havequest(59641) and not completedq(59641)
step
Watch the dialogue
|tip Inside the building.
Attend the War Council |q 46727/1 |goto 85.14,32.63
|only if havequest(46727)
step
click Vision of Sailor's Memory
|tip Inside the building.
Witness the Vision of the Sailor's Memory |q 46727/2 |goto 85.03,32.63
|only if havequest(46727)
step
...
|only if (havequest(46727) or completedq(46727)) and not completedq(46728)
step
...
step
Run down the stairs |goto 44.58,35.82 < 7 |walk
Enter the Sewers |q 47098/7 |goto 39.10,51.40
|tip Downstairs inside the building.
step
Follow the path and leave the tunnel |goto 51.12,47.46 < 10 |walk
...
step
Enter the building |goto 75.57,19.08 < 7 |walk
Watch the dialogue
|tip Inside the building.
Visit the Tradewinds Counting House |q 47099/2 |goto 75.57,17.92
step
Enter the building |goto 73.55,13.71 < 7 |walk
Watch the dialogue
|tip Inside the building.
...
step
Jump down and enter the building |goto 68.83,21.11 < 7 |walk
Watch the dialogue
|tip Inside the building.
...
accept Shipwreck Recovery Crew##50009 |goto 50.36,36.83 |only if level < 10
|tip You will automatically accept this quest. |only if level < 10
...
accept Creature Corruption##49300 |goto 35.20,24.19 |only if level < 10
|tip You will automatically accept this quest. |only if level < 10
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Drustvar (25-50)",{
author="support@zygorguides.com",
description="\nThis guide will assist you in completing the following Drustvar storylines:\n\nThe Final Effigy\nAn Airtight Alibi\nA New Order\nStorming the Manor\nFighting With Fire\nThe Burden of Proof\nThe Order of Embers\nBreak on Through\nClear Victory\nStick It To 'Em!",
condition_suggested=function() return level >= 25 and not completedq(50588) and completedq(47189) end,
startlevel=25,
endlevel=50,
...
accept Fallhaven's Curse##47969 |goto 57.19,35.85 |only if level < 10
|tip You will automatically accept this quest. |only if level < 10
step
...
accept Not the Bees!##48680 |goto 59.45,21.92 |only if level < 10
|tip You will automatically accept this quest. |only if level < 10
...
accept The Accursed Thicket##45972 |goto 55.60,41.18 |only if level < 10
|tip You will automatically accept this quest. |only if level < 10
step
...
step
accept Crypt Keepers##48474 |goto 61.20,44.84 |only if level < 10
|tip You will automatically accept this quest. |only if level < 10
...
accept Break Them to Splinters##48525 |goto 70.07,60.27 |only if level < 10
|tip You will automatically accept this quest. |only if level < 10
...
accept Village Repair##50091 |goto 26.67,72.19 |only if level < 10
|tip You will accept this quest automatically. |only if level < 10
step
...
accept Reclaiming Corlain##50448 |goto 31.78,29.56 |only if level < 10
|tip You will accept this quest automatically. |only if level < 10
step
talk Lucille Waycrest##131638
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Stormsong Valley (35-50)",{
author="support@zygorguides.com",
...
condition_suggested=function() return level >= 35 and not completedq(50733) and completedq(47189) end,
startlevel=35,
endlevel=50,
...
|only if havequest(51534) or completedq(51534) and level < 10
step
talk Sergeant Calvin##130190
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Mechagon Island",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Nazjatar\\Nazjatar",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Nazjatar\\Kelya's Grave",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Nazjatar\\Nazjatar Dropped Quests",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\War Campaign",{
author="support@zygorguides.com",
...
|only if not havequest(52544) and not completedq(52544)
step
...
|tip Use the Leveling guides to accomplish this.
step
accept A Dying World##53028 |goto Boralus/0 73.49,14.43
|tip You will accept this quest automatically.
...
step
Use the Heart of Azeroth ability at the center of the screen
|tip There will be multiple nodes throughout the room to use it at.
...
|only if havequest(51918) or completedq(51918)
step
...
step
talk Halford Wyrmbane##135612
turnin Uniting Kul Tiras##51918 |goto 69.28,27.00 |only if havequest(51918) or completedq(51918)
turnin Uniting Kul Tiras##52450 |goto 69.28,27.00 |only if havequest(52450) or completedq(52450)
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Warfronts\\Arathi Highlands Warfront Extra Quests",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Warfronts\\Darkshore Warfront Extra Quests",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Warfronts\\Warfronts Introduction Quests",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Advanced Adventurer Augment",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Annoy-o-Tron Gang",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Anti-Gravity Pack",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Battle Box",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: BAWLD-371",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Beastbot Powerpack",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Blue Spraybot",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Canned Minnows",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Emergency Powerpack",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Emergency Repair Kit",{
author="support@zygorguides.com",
description="\nThis blueprint has a chance to drop from Cogfrenzy's Construction Toolkit after completing the "..
"\"Cogfrenzy's Construction Frenzy\" daily quest.",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Emergency Rocket Chicken",{
author="support@zygorguides.com",
description="\n.",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Encrypted Black Market Radio",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Experimental Adventurer Augment",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Extraordinary Adventurer Augment",{
author="support@zygorguides.com",
description="\nThis blueprint can be purchased from the Stolen Royal Vendorbot on Mechagon Island for 2,000 gold, adjusted for reputation, after "..
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: G99.99 Landshark",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Green Spraybot",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Holographic Digitalization Relay",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Hundred-Fathom Lure",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Mechano-Treat",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Mechanocat Laser Pointer",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Microbot XD",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Orange Spraybot",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Perfectly Timed Differential",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Personal Time Displacer",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Protocol Transference Device",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Re-Procedurally Generated Punchcard",{
author="support@zygorguides.com",
description="\nTo collect this blueprint, you will farm machine parts at Junkwatt Depot and exchange them for Recycling Requisitions.",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Rustbolt Gramophone",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Rustbolt Kegerator",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Rustbolt Pocket Turret",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Rustbolt Resistance Insignia",{
author="support@zygorguides.com",
description="\nThis blueprint has a small chance to drop from the Rustbolt Supplies paragon reputation cache.",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Rustbolt Requisitions",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Scrap Grenade",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Scrap Trap",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Scrapmaster's Blowtorch",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: S.P.A.R.E. Crate",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Ultrasafe Transporter - Mechagon",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Utility Mechanoclaw",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Mechagon Island\\Blueprints\\Blueprint: Vaultbot Key",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Veiled Grotto (Zuldazar)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Grimwatt's Crash (Nazmir)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Mistvine Ledge (Zuldazar)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Mugamba Overlook (Zuldazar)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Verdant Hollow (Zuldazar)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Scouting Reports\\Vulture's Nest (Vol'dun)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Void Elf Race Unlock",{
author="support@zygorguides.com",
description="\nThis guide will walk you through unlocking the new Void Elf allied race.",
condition_suggested=function() return level >= 50 and not completedq(48962) end,
...
step
Load the "Broken Shore Campaign" Leveling Guide |confirm |next "Leveling Guides\\Legion (10-50)\\Broken Shore Campaign"
|tip Click the line above to load the guide.
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Lightforged Draenei Race Unlock",{
author="support@zygorguides.com",
description="\nThis guide will walk you through unlocking the new Lightforged Draenei allied race.",
condition_suggested=function() return level >= 50 and not completedq(50071) end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Dark Iron Dwarf Race Unlock",{
author="support@zygorguides.com",
...
condition_suggested=function() return level >= 50 and not achieved(12515) and completedq(47189) end,
...
step
Load the "War Campaign" Leveling Guide |confirm |next "Leveling Guides\\Battle for Azeroth (10-50)\\War Campaign"
|tip Click the line above to load the guide.
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Dark Iron Dwarf Mole Machine Locations",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Kul Tiran Race Unlock",{
author="support@zygorguides.com",
...
condition_suggested=function() return level >= 50 and not achieved(13163) and achieved(13467) and achieved(12891) and rep('Proudmoore Admiralty') == Exalted end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Allied Races\\Mechagnome Race Unlock",{
author="support@zygorguides.com",
...
condition_suggested=function() return level >= 50 and not achieved(14013) and achieved(13553) and rep('Rustbolt Resistance') == Exalted end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Drustvar Loremaster (Story Quest Only)",{
author="support@zygorguides.com",
description="\nThis guide will assist you in completing the following Drustvar storylines:\n\nThe Final Effigy\nAn Airtight Alibi\nA New Order\nStorming the Manor\nFighting With Fire\nThe Burden of Proof\nThe Order of Embers\nBreak on Through\nClear Victory\nStick It To 'Em!",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Stormsong Valley Loremaster (Story Quest Only)",{
author="support@zygorguides.com",
description="\nThis guide will assist you in completing the following Stormsong Valley storylines:\n\nThe Tidesages of Stormsong\nThe Growing Tempest\nCycle of Hatred\nBriarback Kraul\nA House in Peril\nAt the Edge of Madness\nFrom the Depths They Come\nTreasure in Deadwash",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Tiragarde Sound Loremaster (Story Quest Only)",{
author="support@zygorguides.com",
description="\nThis guide will assist you in completing the following Tiragarde Sound storylines:\n\nA Nation Divided\nCastaways and Cutouts\nDefenders of Daelin's Gate\nThe Norwington Estate\nThe Ashvane Trading Company\nFreehold\nThe Shadow Over Anglepoint",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Heritage Armor\\Dwarf Heritage Armor",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Heritage Armor\\Gnome Heritage Armor",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Heritage Armor\\Worgen Heritage Armor",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Xal'atath's Gambit",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Xal'atath's Gambit - Priest",{
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the \"Xal'atath's Gambit\" questline "..
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Hati's Sacrifice",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Before the Storm Questline",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Heart of Azeroth\\Essential Empowerment",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Horrific Vision of Stormwind",{
author="support@zygorguides.com",
description="This guide will walk you through completing the \"Horrific Vision of Stormwind\" scenario.",
keywords={"8.3","N'zoth","Nzoth","Corruption"},
condition_suggested=function() return level >= 50 and havequest(57374) or completedq(57374) end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Horrific Vision of Orgrimmar",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (10-50)\\Heart of Azeroth\\Magni's Plan",{
author="support@zygorguides.com",
...
|tip Use the "Tiragarde Sound (10-50)" leveling guide to accomplish this.
step
...
step
Reach the Murloc Hideaway |goto Exile's Reach/0 62.14,84.10 < 30 |noway |c |q 55122 |future
step
talk Captain Garrick##156626
accept Murloc Mania##55122 |goto 61.88,82.89
step
...
step
Follow the path |goto 62.87,67.12 < 20 |only if walking
...
|tip Use the ability on your action bar.
step
Enter the building |goto 51.51,52.92 < 10 |walk
...
step
Enter the cave |goto 51.03,60.45 < 5 |walk
click Thick Cocoon
|tip Inside the cave.
...
step
Follow the path up |goto 55.23,47.96 < 20 |only if walking
...
|tip It flies down from the sky.
...
step
Watch the dialogue
|tip Use your "Freezing Trap" ability.
...
|tip Use your "Dismiss Pet" ability.
|only if Hunter
step
talk Austin Huxworth##161666
Tell him _"I'm ready to tame my pet, call them out."_
Watch the dialogue
|tip Use your "Tame Beast" ability on the Bear that appears nearby.
...
turnin Welcome to Stormwind##59583 |goto 66.37,78.24
accept Finding Your Way##58908 |goto 66.37,78.24
step
talk Stormwind City Guard##68
Tell them _"Stable Master"_
Tell them _"Old Town Stable Master"_
Ask a Guard for Directions to the Stable Master in Old Town |q 58908/1 |goto 66.06,77.65
step
talk Lindie Springstock##163095
Tell him _"Let's head to the Old Town stables."_
Speak with Lindie Springstock |q 58908/2 |goto 66.18,77.03
step
Watch the dialogue
...
step
Enter the building |goto 75.13,55.30 < 7 |walk
...
step
Enter the building |goto 80.62,37.88 < 10 |walk
...
step
Travel to Boralus |goto Boralus/0 65.73,50.63 < 10 |noway |c |q 59641
step
talk Lady Jaina Proudmoore##120922
...
Visit the Ferry Dock |q 47099/1 |goto 74.25,24.58
step
Run up the stairs and enter the building |goto 75.57,19.08 < 7 |walk
Watch the dialogue
|tip Inside the building.
Visit the Tradewinds Counting House |q 47099/2 |goto 75.57,17.92
step
...
turnin Ferry Pass##52128 |goto 68.01,21.89
step
Enter the building |goto 70.40,17.68 < 7 |walk
talk 7th Legion Magus##137066
|tip Inside the building.
Tell her _"The local authority has given us permission to open portals here."_
Speak with the 7th Legion Magus |q 47186/1 |goto 70.74,16.31
step
Enter the building |goto 68.83,21.11 < 7 |walk
talk Taelia##121235
|tip Inside the building.
turnin Sanctum of the Sages##47186 |goto  68.17,21.97
...
|only if havequest(62567) or completedq(62567)
step
_Are You Eligible For Chromie Time?_
|tip If you have another character who reached max level in the Battle For Azeroth expansion, you are eligible for Chromie Time.
|tip You are also eligible if you've already leveled at least one character through the Battle for Azeroth zones during the Shadowlands expansion.
|tip If not, you must level through the Battle for Azeroth zones before moving on to Shadowlands.
|tip Chromie Time allows you to choose a different expansion to level up to 50 in, before moving on to Shadowlands.
No - Level in Battle for Azeroth Zones	|confirm	|or	|next Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Tiragarde Sound (10-50)
...
Battle for Azeroth	|confirm	|or	|next Leveling Guides\\Battle for Azeroth (10-50)\\Kul Tiras\\Tiragarde Sound (10-50)
...
|only if havequest(60959)
step
Click the Complete Quest Box:
turnin To Outland!##60120 |only if havequest(60120) or completedq(60120)
turnin Onward to Adventure: Outland##60959 |only if havequest(60959) or completedq(60959)
step
_Begin Leveling in Burning Crusade:_
|tip Open the "Hellfire Peninsula (10-50)" leveling guide.
Click Here to Return to Chromie |confirm |next "Chromie_Time_Start"
step
label "Wrath_Of_The_Lich_King"
accept To Northrend!##60096			|or |only if havequest(60096)
accept Onward to Adventure: Northrend##60962	|or |only if havequest(60962)
|tip You will accept one of these quests automatically.
step
...
|only if havequest(60962)
step
Click the Complete Quest Box:
turnin To Northrend!##60096 |only if havequest(60096) or completedq(60096)
turnin Onward to Adventure: Northrend##60962 |only if havequest(60962) or completedq(60962)
step
_Begin Leveling in Wrath of the Lich King:_
|tip Open the "Borean Tundra (10-50)" leveling guide.
Click Here to Return to Chromie |confirm |next "Chromie_Time_Start"
step
label "Howling_Fjord"
Locate the Boat to Borean Tundra |goto Stormwind City/0 17.17,25.82 < 15 |c |q 60096
...
step
_Begin Leveling in Wrath of the Lich King:_
|tip Open the "Howling Fjord (10-50)" leveling guide.
Click Here to Return to Chromie |confirm |next "Chromie_Time_Start"
step
...
|tip You will accept this quest automatically.
step
Visit Stormwind Keep |q 60125/1 |goto Stormwind City/0 80.67,37.83
step
...
Secure a Flight to The Skyfire |q 29548/1 |goto 77.70,39.26
step
Fly to the Skyfire |goto Eastern Kingdoms/0 41.51,70.20 < 10 |noway |c |q 29548
step
talk Sky Admiral Rogers##66292
|tip On the flying ship.
Tell her _"I am ready to depart."_
Speak to Admiral Rogers on The Skyfire Gunship |q 29548/2 |goto 41.47,70.19
step
talk Sky Admiral Rogers##66292
turnin The Mission##29548 |goto The Jade Forest/0 42.03,92.75
step
_Begin Leveling in Mists of Pandaria:_
|tip Open the "The Jade Forest (10-50)" leveling guide.
Click Here to Return to Chromie |confirm |next "Chromie_Time_Start"
step
label "Warlords_Of_Draenor"
accept The Dark Portal##34398
|tip You will accept this quest automatically.
step
Run up the ramp and enter the building |goto Stormwind City/0 50.12,87.47 < 7 |only if walking
...
turnin The Dark Portal##34398 |goto Assault on the Dark Portal/0 54.79,48.27
step
_Begin Leveling in Warlords of Draenor:_
|tip Open the "Draenor Intro" leveling guide.
Click Here to Return to Chromie |confirm |next "Chromie_Time_Start"
step
label "Legion"
...
step
_Begin Leveling in Burning Crusade:_
|tip Open the Legion "Intro & Artifacts" leveling guide for your class.
Click Here to Return to Chromie |confirm |next "Chromie_Time_Start"
]])
