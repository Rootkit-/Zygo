...
'|condition skill("Shadowlands Alchemy") >= 175 |or |next "Begin_Profession_Leveling" |only if default
'|condition skill("Shadowlands Alchemy") >= 180 |or |next "Begin_Profession_Leveling" |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 190 |or |next "Begin_Profession_Leveling" |only if Goblin
...
|tip Farm them with Herbalism or purchase them from the auction house.
'|condition skill("Shadowlands Alchemy") >= 20 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 25 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 35 |or |only if Goblin
step
talk Distributor Au'naci##156689
...
|tip Farm them with Herbalism or purchase them from the auction house.
'|condition skill("Shadowlands Alchemy") >= 30 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 35 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 45 |or |only if Goblin
step
Open Your Alchemy Crafting Panel:
...
'|condition skill("Shadowlands Alchemy") >= 45 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 50 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 60 |or |only if Goblin
...
|tip Farm them with Herbalism or purchase them from the auction house.
'|condition skill("Shadowlands Alchemy") >= 55 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 60 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 70 |or |only if Goblin
step
Open Your Alchemy Crafting Panel:
...
'|condition skill("Shadowlands Alchemy") >= 60 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 65 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 75 |or |only if Goblin
...
'|condition skill("Shadowlands Alchemy") >= 80 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 85 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 95 |or |only if Goblin
...
|tip Farm them with Herbalism or purchase them from the auction house.
'|condition skill("Shadowlands Alchemy") >= 97 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 102 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 112 |or |only if Goblin
step
Open Your Alchemy Crafting Panel:
...
'|condition skill("Shadowlands Alchemy") >= 100 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 105 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 115 |or |only if Goblin
...
'|condition skill("Shadowlands Alchemy") >= 110 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 115 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 125 |or |only if Goblin
...
|tip Farm them with Herbalism or purchase them from the auction house.
'|condition skill("Shadowlands Alchemy") >= 120 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 125 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 135 |or |only if Goblin
step
Open Your Alchemy Crafting Panel:
...
'|condition skill("Shadowlands Alchemy") >= 125 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 130 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 140 |or |only if Goblin
step
...
'|condition skill("Shadowlands Alchemy") >= 157 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 162 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 172 |or |only if Goblin
step
...
'|condition skill("Shadowlands Alchemy") >= 170 |or |only if default
'|condition skill("Shadowlands Alchemy") >= 175 |or |only if KulTiran
'|condition skill("Shadowlands Alchemy") >= 185 |or |only if Goblin
step
...
_Or_
Click Here to Collect Materials as You Level or Resume Leveling Shadowlands Alchemy |confirm |next "Begin_Profession_Leveling" |or
'|condition skill("Shadowlands Blacksmithing") >= 100 |or |next "Begin_Profession_Leveling" |only if default
'|condition skill("Shadowlands Blacksmithing") >= 105 |or |next "Begin_Profession_Leveling" |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 110 |or |next "Begin_Profession_Leveling" |only if LightforgedDraenei
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 6 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 11 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 16 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 10 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 15 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 20 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
...
step
Open Your Blacksmithing Crafting Panel:
_<Create 4 Ceremonious Armguards>_
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 16 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 21 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 26 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 18 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 23 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 28 |or |only if LightforgedDraenei
step
Open Your Blacksmithing Crafting Panel:
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 20 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 25 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 30 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
...
collect 24 Laestrite Ore##171828 |or
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 26 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 31 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 36 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
buy 18 Luminous Flux##180733 |goto 38.58,33.48 |or
'|condition skill("Shadowlands Blacksmithing") >= 26 |or |only if default
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 30 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 35 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 40 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 36 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 41 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 46 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 40 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 45 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 50 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
buy 4 Luminous Flux##180733 |goto 38.58,33.48 |or
'|condition skill("Shadowlands Blacksmithing") >= 40 |or |only if default
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 45 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 50 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 55 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
...
collect 35 Laestrite Ore##171828 |or
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 50 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 55 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 60 |or |only if LightforgedDraenei
step
talk Distributor Au'til##156777
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 60 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 65 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 70 |or |only if LightforgedDraenei
step
...
'|condition skill("Shadowlands Blacksmithing") >= 61 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 66 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 71 |or |only if LightforgedDraenei
step
talk Smith Au'berk##156666
...
collect 20 Laestrite Ore##171828 |or
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 70 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 75 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 80 |or |only if LightforgedDraenei
step
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 80 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 85 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 90 |or |only if LightforgedDraenei
step
...
collect 24 Laestrite Ore##171828 |or
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 92 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 97 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 102 |or |only if LightforgedDraenei
step
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Blacksmithing") >= 100 |or |only if default
'|condition skill("Shadowlands Blacksmithing") >= 105 |or |only if DarkIronDwarf or KulTiran
'|condition skill("Shadowlands Blacksmithing") >= 110 |or |only if LightforgedDraenei
step
label "Collect_Elethium_Ore_92"
...
'|condition skill("Shadowlands Cooking") >= 75 |or |next "Begin_Profession_Leveling" |only if default
'|condition skill("Shadowlands Cooking") >= 90 |or |next "Begin_Profession_Leveling" |only if Pandaren
...
|tip Farm them from beasts Shadowlands or purchase them from the auction house.
'|condition skill("Shadowlands Cooking") >= 22 |or |only if default
'|condition skill("Shadowlands Cooking") >= 37 |or |only if Pandaren
step
talk Distributor Au'van##168353
...
|tip Farm them from beasts Shadowlands or purchase them from the auction house.
'|condition skill("Shadowlands Cooking") >= 36 |or |only if default
'|condition skill("Shadowlands Cooking") >= 51 |or |only if Pandaren
step
talk Distributor Au'van##168353
...
|tip Farm them from beasts Shadowlands or purchase them from the auction house.
'|condition skill("Shadowlands Cooking") >= 51 |or |only if default
'|condition skill("Shadowlands Cooking") >= 66 |or |only if Pandaren
step
...
|tip Farm them from beasts Shadowlands or purchase them from the auction house.
'|condition skill("Shadowlands Cooking") >= 61 |or |only if default
'|condition skill("Shadowlands Cooking") >= 76 |or |only if Pandaren
step
...
collect 15 Iridescent Amberjack##173033
|tip Farm them with Fishing or purchase them from the auction house.
'|condition skill("Shadowlands Cooking") >= 66 |or |only if default
'|condition skill("Shadowlands Cooking") >= 81 |or |only if Pandaren
step
...
|tip Farm them from beasts Shadowlands or purchase them from the auction house.
'|condition skill("Shadowlands Cooking") >= 75 |or |only if default
'|condition skill("Shadowlands Cooking") >= 90 |or |only if Pandaren
step
...
step
Create an Enchanting Rod |condition itemcount(164766,22462,16207,6218,52723,22463,22461,11130,6339,44452,11145,109253,114943) >= 1 |or
...
'|condition skill("Shadowlands Enchanting") >= 115 |or |next "Begin_Profession_Leveling" |only if default
'|condition skill("Shadowlands Enchanting") >= 120 |or |next "Begin_Profession_Leveling" |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 125 |or |next "Begin_Profession_Leveling" |only if BloodElf
step
Click Here if You Would Like to Collect All Materials First |confirm |or
_Or_
...
|tip Disenchant them from uncommon (green) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 10 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 15 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 20 |or |only if BloodElf
step
talk Distributor Au'resh##156694
...
|tip Click the "Scroll" button in your enchanting window to place the enchant on a scroll that can be sold.
...
|tip Disenchant them from uncommon (green) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 21 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 26 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 31 |or |only if BloodElf
step
talk Distributor Au'resh##156694
...
|tip Disenchant them from uncommon (green) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 31 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 36 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 41 |or |only if BloodElf
step
...
|tip Disenchant them from uncommon (green) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 41 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 46 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 51 |or |only if BloodElf
step
talk Distributor Au'resh##156694
buy 10 Enchanting Vellum##38682 |goto 47.55,29.05 |or
'|condition skill("Shadowlands Enchanting") >= 41 |or |only if default
...
|tip Disenchant them from uncommon (green) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 45 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 50 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 55 |or |only if BloodElf
step
...
collect 10 Soul Dust##172230 |or
|tip Disenchant them from uncommon (green) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 50 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 55 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 60 |or |only if BloodElf
step
...
collect 10 Soul Dust##172230 |or
|tip Disenchant them from uncommon (green) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 55 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 60 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 65 |or |only if BloodElf
step
...
|tip Disenchant them from uncommon (green) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 70 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 75 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 80 |or |only if BloodElf
step
talk Distributor Au'resh##156694
...
|tip Disenchant them from epic (purple) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 75 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 80 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 85 |or |only if BloodElf
step
...
collect 5 Eternal Crystal##172232 |or
|tip Disenchant them from epic (purple) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 80 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 85 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 90 |or |only if BloodElf
step
...
|tip Disenchant them from rare (blue) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 95 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 100 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 105 |or |only if BloodElf
step
talk Distributor Au'resh##156694
buy 5 Enchanting Vellum##38682 |goto 47.55,29.05 |or
'|condition skill("Shadowlands Enchanting") >= 95 |or |only if default
...
collect 5 Eternal Crystal##172232 |or
|tip Disenchant them from epic (purple) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 100 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 105 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 110 |or |only if BloodElf
step
...
|tip Disenchant them from epic (purple) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 110 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 115 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 120 |or |only if BloodElf
step
...
|tip Disenchant them from epic (purple) items with Enchanting or purchase them from the Auction House.
'|condition skill("Shadowlands Enchanting") >= 115 |or |only if default
'|condition skill("Shadowlands Enchanting") >= 120 |or |only if KulTiran
'|condition skill("Shadowlands Enchanting") >= 125 |or |only if BloodElf
step
...
step
Create an Arclight Spanner |condition itemcount(6219,109253,40772,114943) == 0
...
'|condition skill("Shadowlands Engineering") >= 100 |or |next "Begin_Profession_Leveling" |only if default
'|condition skill("Shadowlands Engineering") >= 105 |or |next "Begin_Profession_Leveling" |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 115 |or |next "Begin_Profession_Leveling" |only if Gnome
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Engineering") >= 100 |or |only if default
'|condition skill("Shadowlands Engineering") >= 105 |or |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 115 |or |only if Gnome
step
...
collect 50 Laestrite Ore##171828 |or
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Engineering") >= 35 |or |only if default
'|condition skill("Shadowlands Engineering") >= 40 |or |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 50 |or |only if Gnome
step
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Engineering") >= 41 |or |only if default
'|condition skill("Shadowlands Engineering") >= 46 |or |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 56 |or |only if Gnome
step
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Engineering") >= 46 |or |only if default
'|condition skill("Shadowlands Engineering") >= 51 |or |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 61 |or |only if Gnome
step
...
collect 12 Laestrite Ore##171828 |or
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Engineering") >= 50 |or |only if default
'|condition skill("Shadowlands Engineering") >= 55 |or |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 65 |or |only if Gnome
step
...
|tip You created these in a previous step.
'|condition skill("Shadowlands Engineering") >= 55 |or |only if default
'|condition skill("Shadowlands Engineering") >= 60 |or |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 70 |or |only if Gnome
step
...
|tip Farm them with Mining or purchase them from the Auction House.
'|condition skill("Shadowlands Engineering") >= 76 |or |only if default
'|condition skill("Shadowlands Engineering") >= 81 |or |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 91 |or |only if Gnome
step
...
|tip Prospect them from Shadowlands ore with Jewelcrafting or purchase them from the Auction House.
'|condition skill("Shadowlands Engineering") >= 91 |or |only if default
'|condition skill("Shadowlands Engineering") >= 96 |or |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 106 |or |only if Gnome
step
...
|tip Farm them from humanoid mobs in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Engineering") >= 97 |or |only if default
'|condition skill("Shadowlands Engineering") >= 102 |or |only if KulTiran
'|condition skill("Shadowlands Engineering") >= 112 |or |only if Gnome
step
...
_Or_
Click Here to Collect Materials as You Level or Resume Leveling Shadowlands Engineering |confirm |next "Begin_Profession_Leveling" |or
'|condition skill("Shadowlands Inscription") >= 100 |or |next "Begin_Profession_Leveling" |only if default
'|condition skill("Shadowlands Inscription") >= 105 |or |next "Begin_Profession_Leveling" |only if KulTiran
'|condition skill("Shadowlands Inscription") >= 115 |or |next "Begin_Profession_Leveling" |only if Nightborne
step
...
|tip You created these in a previous step.
'|condition skill("Shadowlands Inscription") >= 30 |or |only if default
'|condition skill("Shadowlands Inscription") >= 35 |or |only if KulTiran
'|condition skill("Shadowlands Inscription") >= 45 |or |only if Nightborne
step
...
'|condition skill("Shadowlands Inscription") >= 75 |or |only if default
'|condition skill("Shadowlands Inscription") >= 80 |or |only if KulTiran
'|condition skill("Shadowlands Inscription") >= 90 |or |only if Nightborne
step
talk Distributor Au'sha##156732
...
|tip You created these in a previous step.
'|condition skill("Shadowlands Inscription") >= 80 |or |only if default
'|condition skill("Shadowlands Inscription") >= 85 |or |only if KulTiran
'|condition skill("Shadowlands Inscription") >= 95 |or |only if Nightborne
step
...
|tip You created these in a previous step.
'|condition skill("Shadowlands Inscription") >= 86 |or |only if default
'|condition skill("Shadowlands Inscription") >= 91 |or |only if KulTiran
'|condition skill("Shadowlands Inscription") >= 101 |or |only if Nightborne
step
...
|tip You created these in a previous step.
'|condition skill("Shadowlands Inscription") >= 100 |or |only if default
'|condition skill("Shadowlands Inscription") >= 105 |or |only if KulTiran
'|condition skill("Shadowlands Inscription") >= 115 |or |only if Nightborne
step
...
_Or_
Click Here to Collect Materials as You Level or Resume Leveling Shadowlands Engineering |confirm |next "Begin_Profession_Leveling" |or
'|condition skill("Shadowlands Jewelcrafting") >= 100 |or |next "Begin_Profession_Leveling" |only if default
'|condition skill("Shadowlands Jewelcrafting") >= 105 |or |next "Begin_Profession_Leveling" |only if KulTiran
'|condition skill("Shadowlands Jewelcrafting") >= 110 |or |next "Begin_Profession_Leveling" |only if Draenei
stickystart "Collect_Sinvyr_Ore_Total"
step
...
|tip Farm them with Mining or purchase them from the auction house.
'|condition skill("Shadowlands Jewelcrafting") >= 30 |or |only if default
'|condition skill("Shadowlands Jewelcrafting") >= 35 |or |only if KulTiran
'|condition skill("Shadowlands Jewelcrafting") >= 40 |or |only if Draenei
step
...
|tip Farm them with Mining or purchase them from the auction house.
'|condition skill("Shadowlands Jewelcrafting") >= 35 |or |only if default
'|condition skill("Shadowlands Jewelcrafting") >= 40 |or |only if KulTiran
'|condition skill("Shadowlands Jewelcrafting") >= 45 |or |only if Draenei
step
Open Your Jewelcrafting Crafting Panel:
...
|tip You created these in a previous step.
'|condition skill("Shadowlands Jewelcrafting") >= 50 |or |only if default
'|condition skill("Shadowlands Jewelcrafting") >= 55 |or |only if KulTiran
'|condition skill("Shadowlands Jewelcrafting") >= 60 |or |only if Draenei
step
talk Distributor Au'kharn##156733
...
'|condition skill("Shadowlands Jewelcrafting") >= 62 |or |only if default
'|condition skill("Shadowlands Jewelcrafting") >= 67 |or |only if KulTiran
'|condition skill("Shadowlands Jewelcrafting") >= 72 |or |only if Draenei
step
...
|tip You should have these from a previous step.
'|condition skill("Shadowlands Jewelcrafting") >= 74 |or |only if default
'|condition skill("Shadowlands Jewelcrafting") >= 79 |or |only if KulTiran
'|condition skill("Shadowlands Jewelcrafting") >= 84 |or |only if Draenei
step
...
'|condition skill("Shadowlands Jewelcrafting") >= 100 |or |only if default
'|condition skill("Shadowlands Jewelcrafting") >= 105 |or |only if KulTiran
'|condition skill("Shadowlands Jewelcrafting") >= 110 |or |only if Draenei
step
Open Your Jewelcrafting Crafting Panel:
...
'|condition skill("Shadowlands Leatherworking") >= 100 |or |next "Begin_Profession_Leveling" |only if default
'|condition skill("Shadowlands Leatherworking") >= 105 |or |next "Begin_Profession_Leveling" |only if KulTiran
...
|tip These totals are approximate.
|tip You may need slightly more or less than the indicated amount.
'|condition skill("Shadowlands Leatherworking") >= 100 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 105 |or |only if KulTiran
step
...
|tip Farm them with Skinning or purchase them from the Auction House.
'|condition skill("Shadowlands Leatherworking") >= 11 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 16 |or |only if KulTiran
step
talk Distributor Au'tem##156696
...
collect 45 Desolate Leather##172089 |or
|tip Farm them with Skinning or purchase them from the Auction House.
'|condition skill("Shadowlands Leatherworking") >= 21 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 26 |or |only if KulTiran
step
talk Distributor Au'tem##156696
...
|tip Farm them with Skinning or purchase them from the Auction House.
'|condition skill("Shadowlands Leatherworking") >= 36 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 41 |or |only if KulTiran
step
talk Distributor Au'tem##156696
buy 10 Penumbra Thread##177062 |goto 44.48,26.50 |or
'|condition skill("Shadowlands Leatherworking") >= 36 |or |only if default
...
collect 50 Desolate Leather##172089 |or
|tip Farm them with Skinning or purchase them from the Auction House.
'|condition skill("Shadowlands Leatherworking") >= 51 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 56 |or |only if KulTiran
step
talk Distributor Au'tem##156696
...
|tip Farm them with Skinning or purchase them from the Auction House.
'|condition skill("Shadowlands Leatherworking") >= 60 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 65 |or |only if KulTiran
step
talk Distributor Au'tem##156696
...
|tip Farm them with Skinning or purchase them from the Auction House.
'|condition skill("Shadowlands Leatherworking") >= 70 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 75 |or |only if KulTiran
step
...
|tip Farm them with Skinning or purchase them from the Auction House.
'|condition skill("Shadowlands Leatherworking") >= 85 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 90 |or |only if KulTiran
step
Open Your Leatherworking Crafting Panel:
...
|tip Farm them with Skinning or purchase them from the Auction House.
'|condition skill("Shadowlands Leatherworking") >= 88 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 93 |or |only if KulTiran
step
Open Your Leatherworking Crafting Panel:
...
|tip Farm them with Skinning or purchase them from the Auction House.
'|condition skill("Shadowlands Leatherworking") >= 91 |or |only if default
'|condition skill("Shadowlands Leatherworking") >= 96 |or |only if KulTiran
step
...
'|condition skill("Shadowlands Tailoring") >= 100 |or |next "Begin_Profession_Leveling" |only if default
'|condition skill("Shadowlands Tailoring") >= 105 |or |next "Begin_Profession_Leveling" |only if KulTiran
...
|tip These totals are approximate.
|tip You may need slightly more or less than the indicated amount.
'|condition skill("Shadowlands Tailoring") >= 100 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 105 |or |only if KulTiran
step
...
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 15 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 20 |or |only if KulTiran
step
...
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 31 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 36 |or |only if KulTiran
step
talk Distributor Au'tem##156696
...
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 37 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 42 |or |only if KulTiran
step
talk Distributor Au'tem##156696
...
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 52 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 57 |or |only if KulTiran
step
talk Distributor Au'tem##156696
...
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 65 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 70 |or |only if KulTiran
step
Open Your Tailoring Crafting Panel:
...
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 71 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 76 |or |only if KulTiran
step
...
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 75 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 80 |or |only if KulTiran
step
...
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 87 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 92 |or |only if KulTiran
step
...
collect 30 Shrouded Cloth##173202 |or
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 90 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 95 |or |only if KulTiran
step
...
collect 60 Shrouded Cloth##173202 |or
|tip Farm them from humanoid enemies in Shadowlands zones or purchase them from the Auction House.
'|condition skill("Shadowlands Tailoring") >= 96 |or |only if default
'|condition skill("Shadowlands Tailoring") >= 101 |or |only if KulTiran
step
